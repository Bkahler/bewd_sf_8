...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { color: @shirt.color, description: @shirt.description, name: @shirt.name, price: @shirt.price }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { color: @shirt.color, description: @shirt.description, name: @shirt.name, price: @shirt.price }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
